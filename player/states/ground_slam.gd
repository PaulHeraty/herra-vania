...
const BOOM_AUDIO = preload("uid://cp6x23jr6wg6g")
const HIT_WOOD_LARGE = preload("uid://blnfbd54oiq6q")
const HIT_WOOD_MEDIUM = preload("uid://iiwci2lbmy2a")
const HIT_WOOD_SMALL = preload("uid://ryjsr50ge0uo")
const BREAK_WOOD_AUDIO = preload("uid://cyuox05jokoec")
